...
describe("Get Order By Total Price Lower Than", () => {
  test("should return 200 with an order", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    ...
    const getOrder = await supertest(app)
      .get(api + "/getByTotalPriceLower/" + totalPrice)
      .set("Cookie", [...header["set-cookie"]])
      .set("Authorization", `Bearer ${getUser.body.accessToken}`);
...
describe("Get Order By Total Price Lower, without Authorization", () => {
  test("should return 401 with an error", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    ...
    const getOrder = await supertest(app).get(
      api + "/getByTotalPriceLower/" + totalPrice
    );
    // .set("Cookie", [...header["set-cookie"]])
    // .set("Authorization", `Bearer ${getUser.body.accessToken}`);
...
describe("Get Order By Total Price Lower than, order doesn't exist", () => {
  test("should return 200 with an empty list", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    ...
    const getOrder = await supertest(app)
      .get(api + "/getByTotalPriceLower/" + "-1")
      .set("Cookie", [...header["set-cookie"]])
      .set("Authorization", `Bearer ${getUser.body.accessToken}`);
...
describe("Get Order By Address", () => {
  test("should return 200 with an order", async () => {
    ...
    const { shippingAddress } = addOrder.body.order;

    const getOrder = await supertest(app)
      .get(api + "/getByAddress/" + shippingAddress)
      .set("Cookie", [...header["set-cookie"]])
      .set("Authorization", `Bearer ${getUser.body.accessToken}`);
...
describe("Get Order By Address, without Authorization", () => {
  test("should return 401 with an error", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    ...
    const getOrder = await supertest(app).get(
      api + "/getByAddress/" + shippingAddress
    );
    // .set("Cookie", [...header["set-cookie"]])
    // .set("Authorization", `Bearer ${getUser.body.accessToken}`);
...
describe("Get Order By Address, order doesn't exist", () => {
  test("should return 200 with an empty list", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
