...
describe("Get Inventory Data", () => {
  ...
  test("should return the 1 month Inventory data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
  ...
  test("should return the 1 year Inventory data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
  ...
  test("should return the 3 years Inventory data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
  ...
  test("should return the 5 years Inventory data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
...
describe("Get Orders Data", () => {
  ...
  test("should return the Year to date orders data  as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
  ...
  test("should return the 1 Year orders data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
  ...
  test("should return the 3 Year orders data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
  ...
  test("should return the 5 Year orders data as a JSON response with a 200 status code when orders are found", async () => {
    const postUser = await supertest(app)
      .post(authApi + "/register")
      .send(usersFixtures.userInput);
    expect(postUser.status).toEqual(200);
